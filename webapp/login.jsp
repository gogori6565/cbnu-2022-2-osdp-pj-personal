      ...
      <div class="col-lg-4">
         <div class="jumbotron" style="padding-top: 20px;">
            <form method="post" action="loginAction.jsp">
               ...
               <input type="submit" class="btn btn-primary form-control" value="로그인" style="height:40px; font-family: 'Jua', sans-serif; font-size:20px; color:#ffffff; background-color: #4169E1;">
            </form>   
         </div>   
      </div>
         <div class="col-lg-4"></div>
